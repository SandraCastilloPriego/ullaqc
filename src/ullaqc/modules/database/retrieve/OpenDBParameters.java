...
public class OpenDBParameters extends SimpleParameterSet {
  
    static Object[] objects = Database.getMolecules();
    ...
    public OpenDBParameters() {
        super(new Parameter[]{dbMolecules});
    }
}
