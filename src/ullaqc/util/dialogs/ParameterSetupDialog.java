...
import ullaqc.util.components.ExtendedCheckBox;
import ullaqc.util.components.HelpButton;
...
public class ParameterSetupDialog extends JDialog implements ActionListener {
        ...
        public ParameterSetupDialog(String title, SimpleParameterSet parameters,
                ...
                // Make dialog modal
                super(UllaQCCore.getDesktop().getMainFrame(), title, true);
                                ...
                                btnFileBrowser.addActionListener(new ActionListener() {
                                        ...
                                        public void actionPerformed(ActionEvent e) {
                                                ...
                                                int returnVal = fileChooser.showDialog(
                                                        UllaQCCore.getDesktop().getMainFrame(), "Select");
        ...
        public void actionPerformed(ActionEvent ae) {
                ...
                if (src == btnOK) {
                        try {
                                ...
                                UllaQCCore.getDesktop().displayErrorMessage(
