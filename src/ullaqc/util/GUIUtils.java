...
import ullaqc.util.Tables.impl.PushableTable;
import ullaqc.util.components.FileUtils;
import ullaqc.util.internalframe.DataInternalFrame;
...
public class GUIUtils {
        ...
        public static void showNewTable(Dataset dataset, boolean addDataset) {
                ...
                if (addDataset) {
                        UllaQCCore.getDesktop().AddNewFile(dataset);
                }
