...
import ullaqc.taskcontrol.TaskPriority;
import ullaqc.taskcontrol.TaskStatus;
import ullaqc.util.GUIUtils;
import ullaqc.util.components.ComponentCellRenderer;
...
public class TaskProgressWindow extends JInternalFrame implements
        ...
        public TaskProgressWindow() {
                ...
                try {
                        ...
                        TaskControllerImpl taskController = (TaskControllerImpl) UllaQCCore.getTaskController();
