 ...
 */
public interface Desktop extends UllaQCModule {
         ...
         *
         * @param parentMenu UllaQCMenu where to create the new item
        ...
        /**
         * Adds a separator to a given UllaQC menu
         *
