...
public class UllaQCHelpMap implements Map {
        ...
        public void setTarget(String target) {
                String url;
                if (test) {
                        url = "jar:file:" + System.getProperty("user.dir") + "/dist/UllaQC.jar!/" + target;
                } else {
                        url = "jar:file:" + System.getProperty("user.dir") + "/UllaQC.jar!/" + target;
                }
